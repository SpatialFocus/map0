...
> **Early preview — version 0.0.4.** The client works against real OGC services — it is what the
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/map0-viewer@0.0.4/dist/map0.js"></script>
```

unpkg serves the same tarball, if you prefer it:
`https://unpkg.com/map0-viewer@0.0.4/dist/map0.js`.
