...
> **Early preview — version 0.2.0.** The client works against real OGC services — it is what the
...
`https://unpkg.com/map0-viewer@0.2.0/dist/map0.js`.
...
`https://cdn.jsdelivr.net/npm/map0-viewer@0.2.0/schema/v1.json`.
